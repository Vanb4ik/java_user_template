...
@EnableJpaRepositories(basePackages = { "com.vebinar.service", "com.vebinar.dao" }, transactionManagerRef = "jpaTransactionManager")
@EnableJpaAuditing
@PropertySource({ "classpath:persistence-mysql.properties" })
@ComponentScan({"com.vebinar.service", "com.vebinar.dao"})//repository
public class SpringConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.vebinar.entyty.model" });
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan(new String[] { "com.vebinar.entyty.model" });
